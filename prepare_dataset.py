...
def main():
	...
	ap.add_argument("--data_dir", type = str, required = True,
					help = "Directory to raw image data")
	...
	for key in train_list.keys():
		convert_dataset(train_list[key], 'train', args.data_dir, args.out_dir, key, args.partition)

		convert_dataset(val_list[key], 'val', args.data_dir, args.out_dir, key, args.partition)

	convert_dataset(test_list, "test", args.data_dir, args.out_dir, 0, 1)
